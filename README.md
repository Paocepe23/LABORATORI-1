...
No son exactamente iguales. Aunque intente generar una señal del mismo tipo, existen varias razones fisiológicas y técnicas para estas diferencias.
...
El tipo de ruido afecta significativamente el valor de la SNR (Relación Señal-Ruido). Las razones principales son:
